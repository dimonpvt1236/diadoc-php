...
namespace Diadoc\Proto\Workflows\OperatorConfirmationBehavior;

use UnexpectedValueException;

/**
 * Protobuf type <code>Diadoc.Proto.Workflows.OperatorConfirmationBehavior.OperatorConfirmationBehavior</code>
 */
